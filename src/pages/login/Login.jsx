...
// import { userPostPorgotPasswordMutation } from "@/service/user";
// import { toast } from "react-toastify";

// export default function Login() {
//     const [state, setState] = React.useState(null);
//     const { control, handleSubmit, reset } = useForm();
//     const { mutate } = useMutation({ mutationFn: (data) => userPostPorgotPasswordMutation(data) })
...
//                     <form onSubmit={handleSubmit(Submit)} className="relative mb-5">
//                         <CustomInput
//                             name="email"
//                             control={control}
//                             label="Email"
...
//                                 className="text-sm text-blue-600 hover:underline cursor-pointer transition"
//                             >
//                                 Back
//                             </Button>
//                         </div>
...
//                         </Button>
//                     </form>
//                     <p className="text-center text-textGrey">We'll send you a link to reset your password if the account exists.</p>
//                 </div>
//             ) : (
